...
class Op:
    ...
    def __init__(self, generator=None, fitness=None, mutation='mutate_point_ind', 
                 crossover='crossover_uniform_ind', tracer=tracer):
        """
    ...
    def crossover_uniform_ind(self, sol1, sol2):
        ...
        """
        alignment = self._align_genotypes(sol1, sol2)
        new_geno_alignment = { key : sol1.geno[key].crossover(sol2.geno[key]) 
